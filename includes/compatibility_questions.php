...
$compatibility_questions = [
    ...
    'food_preference' => [
        'label'   => 'Food types you actually enjoy — rank your preferences',
        'type'    => 'rank',    
        'max'     => 99,
        'min'     => 2,
        'options' => ['Seafood','Spicy food','Sweet treats','Fast food', 'Street food', 'Mom\'s cooking','Vegetarian / Vegan','BBQ / Grilled','Pasta', 'Fried food','Healthy / Organic','Desserts and pastries','Junk food','Breakfast food','Pizza','Burgers','Soup / Noodles'],
    ],
    'coffee_preference' => [
        'label'   => 'Drinks you usually have — rank your preferences',
        'type'    => 'rank',
        'max'     => 99,
        'min'     => 2,
        'options' => ['Coffee','Milk tea','Juice / smoothies','Soft drinks','Water','Beer / alcohol','Wine','Cocktails','Energy drinks','Iced drinks'],
    ],
    'crowd_preference' => [
    ...
    'conversation_style' => [
        'label'   => 'Conversation style — rank what fits you',
        'type'    => 'rank',
        'max'     => 99,
        'min'     => 2,
        'options' => ['Deep / meaningful talks','Funny and random','Go with the flow','Comfortable silence','Good banter / playful teasing', 'A mix of serious and funny', 'Light and easy'],
    ],
    'spontaneity_level' => [
